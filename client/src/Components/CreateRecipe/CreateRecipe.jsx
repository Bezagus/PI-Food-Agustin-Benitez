        ...
        <div>
            ...
            <div className="div__constiner">
                <form onSubmit={(e) => handleSubmit(e)} className='form'>
                    ...
                    <div>
                        <div>
                            <label className="label_cont nombre">Nombre</label>
                            <input className="label_cont" type='text' value={input.name} name='name' onChange={(e) => handleChange(e)}/>
                        ...
                        <div>
                            ...
                            <input className='input_cont' type='number' value={input.healthScore} name='healthScore' onChange={(e) => handleChange(e)}/>
                        </div>
                        <div>
                            <label className="label_cont">Instrucciones</label>
                        ...
                        <div>
                            ...
                            <textarea className='input_cont' type='text' value={input.img} name='img' onChange={(e) => handleChange(e)}/>
                        </div>
                        <div>
                            {allDiets.map(el=>{
                                return(
                                    <label className="label_cont">
